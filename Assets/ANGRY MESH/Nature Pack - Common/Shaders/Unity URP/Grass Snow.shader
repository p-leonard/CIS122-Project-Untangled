	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				half temp_output_1_0_g46 = input.ase_color.r;
				...
				output.ase_texcoord10 = vertexToFrag18_g48;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex1 = input.ase_texcoord9.xy;
				half4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				half4 vertexToFrag18_g48 = input.ase_texcoord10;
				half4 TintColor229 = vertexToFrag18_g48;
				float2 uv_BumpMap23 = input.ase_texcoord9.xy;
				...
				half4 lerpResult8 = lerp( ( _BaseBottomColor * lerpResult215 ) , lerpResult215 , saturate( pow( abs( ( input.ase_color.r * 2.0 ) ) , _BaseBottomOffset ) ));
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				half4 lerpResult19_g48 = lerp( temp_cast_2 , lerpResult17_g48 , AG_TintToggle);
				half4 vertexToFrag18_g48 = lerpResult19_g48;
				output.ase_texcoord5 = vertexToFrag18_g48;
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_MainTex1 = input.ase_texcoord4.xy;
				half4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				half4 vertexToFrag18_g48 = input.ase_texcoord5;
				half4 TintColor229 = vertexToFrag18_g48;
				float2 uv_BumpMap23 = input.ase_texcoord4.xy;
				half3 Output_Normal96 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap23 ), 1.0f );
				half3 desaturateInitialColor301 = Output_Normal96;
				half desaturateDot301 = dot( desaturateInitialColor301, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar301 = lerp( desaturateInitialColor301, desaturateDot301.xxx, 1.0 );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				half4 lerpResult19_g48 = lerp( temp_cast_2 , lerpResult17_g48 , AG_TintToggle);
				half4 vertexToFrag18_g48 = lerpResult19_g48;
				output.ase_texcoord3 = vertexToFrag18_g48;
				half3 ase_worldTangent = TransformObjectToWorldDir(input.ase_tangent.xyz);
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_MainTex1 = input.ase_texcoord2.xy;
				half4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				half4 vertexToFrag18_g48 = input.ase_texcoord3;
				half4 TintColor229 = vertexToFrag18_g48;
				float2 uv_BumpMap23 = input.ase_texcoord2.xy;
				half3 Output_Normal96 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap23 ), 1.0f );
				half3 desaturateInitialColor301 = Output_Normal96;
				half desaturateDot301 = dot( desaturateInitialColor301, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar301 = lerp( desaturateInitialColor301, desaturateDot301.xxx, 1.0 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_BumpMap23 = input.ase_texcoord5.xy;
				half3 Output_Normal96 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap23 ), 1.0f );
				
				float2 uv_MainTex1 = input.ase_texcoord5.xy;
				half4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				half Output_OpacityMask58 = ( _Color.a * tex2DNode1.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 uv_MainTex1 = input.ase_texcoord.xy;
				half4 tex2DNode1 = tex2D( _MainTex, uv_MainTex1 );
				half Output_OpacityMask58 = ( _Color.a * tex2DNode1.a );
...
Node;AmplifyShaderEditor.ColorNode;32;-1792,-832;Half;False;Property;_Color;Base Color;4;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;213;-1792,-352;Float;False;Property;_TopColor;Top Color;12;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.7279412,0.7279412,0.7279412,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;6;-1792,-1024;Half;False;Property;_BaseBottomColor;Base Bottom Color;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.5808823,0.5808823,0.5808823,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;23;256,-1008;Inherit;True;Property;_BumpMap;Normal Map;8;2;[NoScaleOffset];[Normal];Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;224;256,512;Half;False;Property;_TintColor1;Tint Color 1;13;0;Create;True;0;0;0;False;1;Header(Tint Color);False;1,1,1,0;1,1,1,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;319;2176,-944;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=E55D75C1B0EEF955E411533AF304BF740DFDE6A3