	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BaseAlbedoASmoothness162 = input.ase_texcoord9.xy;
				...
				float2 uv_BaseNormalMap96 = input.ase_texcoord9.xy;
				...
				half2 texCoord279 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_BaseNormalMap288 = input.ase_texcoord9.xy;
				...
				float2 uv_BaseAOANoiseMask200 = input.ase_texcoord9.xy;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_BaseAlbedoASmoothness162 = input.ase_texcoord4.xy;
				half4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				half2 texCoord194 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				half4 tex2DNode172 = tex2D( _TopAlbedoASmoothness, temp_output_195_0 );
				float2 uv_BaseNormalMap96 = input.ase_texcoord4.xy;
				half3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				half3 tex2DNode96 = unpack96;
				float3 NormalMap166 = tex2DNode96;
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_BaseAlbedoASmoothness162 = input.ase_texcoord2.xy;
				half4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				half2 texCoord194 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				half4 tex2DNode172 = tex2D( _TopAlbedoASmoothness, temp_output_195_0 );
				float2 uv_BaseNormalMap96 = input.ase_texcoord2.xy;
				half3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				half3 tex2DNode96 = unpack96;
				float3 NormalMap166 = tex2DNode96;
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_BaseNormalMap96 = input.ase_texcoord5.xy;
				half3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				half3 tex2DNode96 = unpack96;
				float2 uv_BaseNormalMap288 = input.ase_texcoord5.xy;
				half3 unpack288 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) );
				unpack288.z = lerp( 1, unpack288.z, saturate(( _BumpScale * 0.5 )) );
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
...
Node;AmplifyShaderEditor.ColorNode;269;-4608,-1536;Half;False;Constant;_Color0;Color 0;20;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;175;-2048,-1760;Half;False;Property;_TopColor;Top Color;15;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;165;-2688,-2176;Half;False;Property;_BaseColor;Base Color;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;288;-2048,-544;Inherit;True;Property;_TextureSample2;Texture Sample 2;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;119;-2048,-320;Inherit;True;Property;_TopNormalMap;Top NormalMap;17;2;[Normal];[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=623FE2C97DE78B3C8E0F92FB4F23E049A278B058